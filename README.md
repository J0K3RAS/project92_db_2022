...
|  Αριθμός Μητρώου   |    ge18088                |      ge18801                |      el19139                 |
...
- [Προαπαιτούμενα της εφαρμογής](#προαπαιτούμενα-της-εφαρμογής)
  ...
  * [Εγκατάσταση των πακέτων της python](#εγκατάσταση-των-πακέτων-της-python)
...
- [Επισκόπηση της βάσης](#επισκόπηση-της-βάσης) 
  * [Τελικό ER diagram](#τελικό-er-diagram)
  * [Σχεσιακό Διάγραμμα](#σχεσιακό-διάγραμμα)
  * [Πίνακες](#πίνακες)
  * [Παραδοχές](#παραδοχές)
  * [Triggers](#triggers)
  * [Ευρετήρια](#ευρετήρια)
