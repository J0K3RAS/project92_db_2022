...
- [Προαπαιτούμενα της εφαρμογής](#προαπαιτούμενα-της-εφαρμογής)
  * [Εγκατάσταση της βάσης σε περιβάλλον linux μέσω docker](#-linux-docker)
- [Εγκατάσταση της εφαρμογής](#--1)
  * [Εισαγωγή του ddl αρχείου](#-ddl-)
  * [Εισαγωγή του dml αρχείου](#-dml-)
  * [Τρέχοντας τον web server](#-web-server)
  * [Triggers](#triggers)
